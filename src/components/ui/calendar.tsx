    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "absolute left-1 top-0 h-7 w-7 bg-transparent p-0 text-text-muted hover:text-text-primary border-border-default"
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "absolute right-1 top-0 h-7 w-7 bg-transparent p-0 text-text-muted hover:text-text-primary border-border-default"
        ),
        ...
        day_button: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 text-text-primary hover:bg-surface-muted"
        ),
